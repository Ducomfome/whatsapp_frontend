...
import Linkify from 'react-linkify'; // 1. IMPORTAMOS A NOVA BIBLIOTECA
import './Message.css';

// ... (Seus ícones PlayIcon, PauseIcon, etc. continuam aqui)
...
function Message({ message }) {
  ...
  if (message.sender === 'bot') {
    ...
    switch (message.type) {
      ...
      case 'text':
        // 2. MUDANÇA PARA DEIXAR O LINK CLICÁVEL
        contentNode = (
